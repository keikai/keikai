...
//		}
	...
	public static void setFillOptions(SBook book,CellStyleHolder holder, String bgColor, String fillColor, SFill.FillPattern pattern){
		...
		final SFill.FillPattern orgPattern = orgStyle.getFillPattern();
...
//	}
	...
	public static SCellStyle getLeftStyle(SCellStyle cellStyle, SCellStyle tbStyle, SConditionalStyle cdStyle) {
		return cdStyle != null && cdStyle.getBorderLeft() != null ? cdStyle : 
			tbStyle == null || cellStyle.getBorderLeft() != SBorder.BorderType.NONE ? cellStyle : tbStyle;
	}
	//ZSS-977
	//@since 3.8.0
	@Deprecated
	...
	public static SCellStyle getTopStyle(SCellStyle cellStyle, SCellStyle tbStyle, SConditionalStyle cdStyle) {
		return cdStyle != null && cdStyle.getBorderTop() != null ? cdStyle :
				tbStyle == null || cellStyle.getBorderTop() != SBorder.BorderType.NONE ? cellStyle : tbStyle;
	}
	//ZSS-977
	//@since 3.8.0
	@Deprecated
	...
	public static SCellStyle getRightStyle(SCellStyle cellStyle, SCellStyle tbStyle, SConditionalStyle cdStyle) {
		return cdStyle != null && cdStyle.getBorderRight() != null ? cdStyle :
				tbStyle == null || cellStyle.getBorderRight() != SBorder.BorderType.NONE ? cellStyle : tbStyle;
	}
	//ZSS-977
	//@since 3.8.0
	@Deprecated
	...
	public static SCellStyle getBottomStyle(SCellStyle cellStyle, SCellStyle tbStyle, SConditionalStyle cdStyle) {
		return cdStyle != null && cdStyle.getBorderBottom() != null ? cellStyle :
			tbStyle == null || cellStyle.getBorderBottom() != SBorder.BorderType.NONE ? cellStyle : tbStyle;
	}
	...
	public static void setNewCellStyle(CellStyleHolder holder, SCellStyle cellStyle) {
		...
		if (holder instanceof SCell) {
			...
			if (!cell.getSheet().getRow(cell.getRowIndex()).isCustomHeight()) {
				final SCell.CellType type = cell.getType();
				if (rotate != rotate0
					|| indent != indent0
					|| !font.equals(font0)
					|| (type == SCell.CellType.STRING && processWrap)) {
