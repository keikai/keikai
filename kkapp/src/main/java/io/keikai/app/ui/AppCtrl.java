...
import static io.keikai.app.CollaborationInfo.CollaborationEvent;
import static io.keikai.app.CollaborationInfo.CollaborationEventListener;
...
import io.keikai.app.impl.CollaborationInfoImpl;
import io.keikai.app.repository.BookRepositoryFactory;
import io.keikai.app.repository.impl.BookUtil;
import io.keikai.app.repository.impl.SimpleBookInfo;
import io.keikai.app.ui.dlg.DlgCallbackEvent;
import io.keikai.app.ui.dlg.HyperlinkCtrl;
import io.keikai.app.ui.dlg.OpenManageBookCtrl;
import io.keikai.app.ui.dlg.SaveBookAsCtrl;
import io.keikai.app.ui.dlg.ShareBookCtrl;
import io.keikai.app.ui.dlg.UsernameCtrl;
...
public class AppCtrl extends CtrlBase<Component>{
	...
	private void doExportBook(){
		...
		File file;
		try {
			Book.BookType bookType = loadedBook.getType();
		...
		HyperlinkCtrl.show(new SerializableEventListener<DlgCallbackEvent>(){
			...
			public void onEvent(DlgCallbackEvent event) throws Exception {
				if(HyperlinkCtrl.ON_OK.equals(event.getName())){
					...
					CellOperationUtil
							.applyHyperlink(range, Hyperlink.HyperlinkType.URL, address, label);
				}
			}}, address, display);
	}
