 ...
 * @since 3.0.0
 */
public class DefaultUserActionManagerCtrl implements UserActionManagerCtrl,
		UserActionManager {
...
//		_interestedEvents.add(Events.ON_CELL_DOUBLE_CLICK);
	...
	private void initDefaultAuxHandlers() {
		...
		registerHandler(category, AuxAction.BORDER.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.EDGE_BOTTOM, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_BOTTOM.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.EDGE_BOTTOM, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_TOP.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.EDGE_TOP, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_LEFT.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.EDGE_LEFT, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_RIGHT.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.EDGE_RIGHT, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_NO.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.FULL, CellStyle.BorderType.NONE));
		registerHandler(category, AuxAction.BORDER_ALL.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.FULL, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_OUTSIDE.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.OUTLINE, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_INSIDE.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.INSIDE, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_INSIDE_HORIZONTAL.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.INSIDE_HORIZONTAL, CellStyle.BorderType.THIN));
		registerHandler(category, AuxAction.BORDER_INSIDE_VERTICAL.getAction(), new ApplyBorderHandler(
				Range.ApplyBorderType.INSIDE_VERTICAL, CellStyle.BorderType.THIN));
		...
		registerHandler(category, AuxAction.VERTICAL_ALIGN_TOP.getAction(), new VerticalAlignHandler(
				CellStyle.VerticalAlignment.TOP));
		registerHandler(category, AuxAction.VERTICAL_ALIGN_MIDDLE.getAction(), new VerticalAlignHandler(
				CellStyle.VerticalAlignment.CENTER));
		registerHandler(category, AuxAction.VERTICAL_ALIGN_BOTTOM.getAction(), new VerticalAlignHandler(
				CellStyle.VerticalAlignment.BOTTOM));
		registerHandler(category, AuxAction.HORIZONTAL_ALIGN_LEFT.getAction(), new HorizontalAlignHandler(
				CellStyle.Alignment.LEFT));
		registerHandler(category, AuxAction.HORIZONTAL_ALIGN_CENTER.getAction(), new HorizontalAlignHandler(
				CellStyle.Alignment.CENTER));
		registerHandler(category, AuxAction.HORIZONTAL_ALIGN_RIGHT.getAction(), new HorizontalAlignHandler(
...
//			action = "keyStroke";
	...
	protected void updateClipboardEffect(Sheet sheet) {
		//to sync the 
		UserActionContext.Clipboard cb = getClipboard();
		if (cb != null) {
	...
	protected UserActionContext.Clipboard getClipboard() {
		return (UserActionContext.Clipboard)_sparedsheet.getAttribute(CLIPBOARD_KEY);
	}
	
	protected void clearClipboard() {
		UserActionContext.Clipboard cp = (UserActionContext.Clipboard)_sparedsheet.removeAttribute(CLIPBOARD_KEY);
		if(cp!=null){
			_sparedsheet.setHighlight(null);
		}
	}
