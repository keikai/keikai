...
//	private final int rlastColumn;
	...
	public PasteSpecialCellAction(String label, 
			...
			Range.PasteType pasteType, Range.PasteOperation pasteOperation, boolean skipBlank, boolean transpose) {
	...
	protected boolean isSheetProtected(){
		return isAnyCellProtected(_destSheet, computePastingRegion()) 
			&& (_pasteType != Range.PasteType.FORMATS || !Ranges.range(_sheet).getSheetProtection().isFormatCellsAllowed());
	}
	...
	protected void applyAction() {
		...
		_pastedRange = CellOperationUtil
				.pasteSpecial(src, dest, _pasteType, _pasteOperation, _skipBlank, _transpose);
