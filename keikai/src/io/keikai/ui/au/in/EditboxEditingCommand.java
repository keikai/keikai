...
import io.keikai.ui.event.EditboxEditingEvent;
...
public class EditboxEditingCommand extends AbstractCommand implements Command {
	...
	public void process(AuRequest request) {
		...
		if (!getSheetUuid(sheet).equals(sheetId))
			return;
		EditboxEditingEvent event = new EditboxEditingEvent(
				io.keikai.ui.event.Events.ON_EDITBOX_EDITING, comp, sheet, row,col, clienttxt);
