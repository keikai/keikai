...
public class HeaderMouseCommand extends AbstractCommand implements Command {
	...
	public void process(AuRequest request) {
		...
		if ("lc".equals(type)) {
			type = io.keikai.ui.event.Events.ON_HEADER_CLICK;
		} else if ("rc".equals(type)) {
			type = io.keikai.ui.event.Events.ON_HEADER_RIGHT_CLICK;
		} else if ("dbc".equals(type)) {
			type = io.keikai.ui.event.Events.ON_HEADER_DOUBLE_CLICK;
		} else {
